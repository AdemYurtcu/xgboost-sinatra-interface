...
public class DMatrix {
     ...
     */
    public DMatrix(final String dataPath) throws XGBoostError {
        if (dataPath == null) {
     ...
     * @throws org.dmlc.xgboost4j.util.XGBoostError
     */
    public DMatrix(final long[] headers, final int[] indices, final float[] data, final SparseType st) throws XGBoostError {
        final long[] out = new long[1];
     ...
     * @throws org.dmlc.xgboost4j.util.XGBoostError
     */
    public DMatrix(final float[] data, final int nrow, final int ncol) throws XGBoostError {
        final long[] out = new long[1];
     ...
     * @param handle
     */
    private DMatrix(final long handle) {
        this.handle = handle;
    }
     ...
     * @param labels
     */
    public void setLabel(final float[] labels) throws XGBoostError {
        ErrorHandle.checkCall(XgboostJNI.XGDMatrixSetFloatInfo(this.handle, "label", labels));
    }
     ...
     * @throws org.dmlc.xgboost4j.util.XGBoostError
     */
    public void setWeight(final float[] weights) throws XGBoostError {
        ErrorHandle.checkCall(XgboostJNI.XGDMatrixSetFloatInfo(this.handle, "weight", weights));
    }
     ...
     * @throws org.dmlc.xgboost4j.util.XGBoostError
     */
    public void setBaseMargin(final float[] baseMargin) throws XGBoostError {
        ErrorHandle.checkCall(XgboostJNI.XGDMatrixSetFloatInfo(this.handle, "base_margin", baseMargin));
    }
     ...
     */
    public void setBaseMargin(final float[][] baseMargin) throws XGBoostError {
        final float[] flattenMargin = flatten(baseMargin);
     ...
     * @throws org.dmlc.xgboost4j.util.XGBoostError
     */
    public void setGroup(final int[] group) throws XGBoostError {
        ErrorHandle.checkCall(XgboostJNI.XGDMatrixSetGroup(this.handle, group));
    }

    private float[] getFloatInfo(final String field) throws XGBoostError {
        final float[][] infos = new float[1][];
        ErrorHandle.checkCall(XgboostJNI.XGDMatrixGetFloatInfo(this.handle, field, infos));
        return infos[0];
    }

    private int[] getIntInfo(final String field) throws XGBoostError {
        final int[][] infos = new int[1][];
        ErrorHandle.checkCall(XgboostJNI.XGDMatrixGetUIntInfo(this.handle, field, infos));
        return infos[0];
    }
     ...
     * @throws org.dmlc.xgboost4j.util.XGBoostError
     */
    public DMatrix slice(final int[] rowIndex) throws XGBoostError {
        final long[] out = new long[1];
        ErrorHandle.checkCall(XgboostJNI.XGDMatrixSliceDMatrix(this.handle, rowIndex, out));
        final long sHandle = out[0];
        final DMatrix sMatrix = new DMatrix(sHandle);
        return sMatrix;
    }
    ...
    public long rowNum() throws XGBoostError {
        final long[] rowNum = new long[1];
        ErrorHandle.checkCall(XgboostJNI.XGDMatrixNumRow(this.handle, rowNum));
        return rowNum[0];
    }
     ...
     * @param filePath
     */
    public void saveBinary(final String filePath) {
     ...
     * @return
     */
    private static float[] flatten(final float[][] mat) {
        int size = 0;
        for (final float[] array : mat) {
            size += array.length;
        }
        final float[] result = new float[size];
        int pos = 0;
        for (final float[] ar : mat) {
